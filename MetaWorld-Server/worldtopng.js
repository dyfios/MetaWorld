...
this.dbFile = "./chunk-" + this.chunkXIndex + "." + this.chunkYIndex + ".db";
this.layersFile = "./layers-" + this.chunkXIndex + "." + this.chunkYIndex + ".png";
this.heightsFile = "./heights-" + this.chunkXIndex + "." + this.chunkYIndex + ".png";
this.terrainFile = "./terrain-" + this.chunkXIndex + "." + this.chunkYIndex + ".png";
